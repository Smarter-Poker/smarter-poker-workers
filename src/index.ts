...
import { diamondCustodyRecovery } from './routes/diamond-custody-recovery.js';
...
app.get('/cron/diamond-custody-recovery', diamondCustodyRecovery);
app.post('/cron/diamond-custody-recovery', diamondCustodyRecovery);
